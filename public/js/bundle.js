      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'You are logged out ! Please try again');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.querySelector('.update-password-btn').textContent = 'Updating...';
          ...
          case 7:
            ...
            document.querySelector('.update-password-btn').textContent = 'Save password';
